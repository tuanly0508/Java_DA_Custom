...
public class GiaNgayLeDlg extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblGiaNgayLe = new GUI.Table();
        txtGia = new GUI.TextField();
        btnThemGia = new GUI.Button();
        lblErr = new javax.swing.JLabel();
        txtGiaNgayLe = new GUI.TextField();
        btnDatGia = new GUI.Button();
    ...
    public GUI.Button btnDatGia;
    public GUI.Button btnThemGia;
    ...
    public GUI.Table tblGiaNgayLe;
    public GUI.TextField txtGia;
    public GUI.TextField txtGiaNgayLe;
