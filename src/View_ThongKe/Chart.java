...
import View_ThongKe.BlankPlotChart;
import View_ThongKe.BlankPlotChatRender;
import View_ThongKe.SeriesSize;
...
public class Chart extends javax.swing.JPanel {
        ...
        blankPlotChart.setBlankPlotChatRender(new BlankPlotChatRender() {
            ...
            public void renderSeries(BlankPlotChart chart, Graphics2D g2, SeriesSize size, int index) {
                ...
                if (showLabel != null) {
                    ...
                    int space = 3;
                    int spaceTop = 5;
                    g2.setColor(new Color(239, 240, 249));
                    ...
                    g2.setColor(new Color(195, 5, 186));
    ...
    private void initComponents() {
        ...
        blankPlotChart = new View_ThongKe.BlankPlotChart();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(blankPlotChart, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
    ...
    private View_ThongKe.BlankPlotChart blankPlotChart;
