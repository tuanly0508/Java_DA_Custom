...
public class QuenMatKhau extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnDone = new swing.Button();
        btnSearch = new swing.Button();
        btnFail = new swing.Button();
        btnSearchCode = new swing.Button();
        btnDoneCode = new swing.Button();
        btnFailCode = new swing.Button();
        ...
        btnBackLogin = new swing.Button();
        txtPass = new View_Login.PasswordField();
        txtRePass = new View_Login.PasswordField();
    ...
    private swing.Button btnBackLogin;
    private swing.Button btnDone;
    private swing.Button btnDoneCode;
    private swing.Button btnFail;
    private swing.Button btnFailCode;
    private swing.Button btnSearch;
    private swing.Button btnSearchCode;
    ...
    private View_Login.PasswordField txtRePass;
